...
class TwitterOauthSource extends DataSource {
	...
	function trends_current($params=array()) {
		$url = 'https://search.twitter.com/trends/current.json';
		return $this->__query($url,$params,'get');
	}
	function trends_daily($params=array()) {
		$url = 'https://search.twitter.com/trends/daily.json';
		return $this->__query($url,$params,'get');
	}
	function trends_weekly($params=array()) {
		$url = 'https://search.twitter.com/trends/weekly.json';
		return $this->__query($url,$params,'get');
	}
	/* REST API */
	/* Timeline Wrappers */
	...
	function statuses_mentions($params=array()) {
		$url = 'https://twitter.com/statuses/mentions.json';
		return $this->__query($url,$params,'get');
	}
	function statuses_retweeted_by_me($params=array()) {
		$url = 'https://twitter.com/statuses/retweeted_by_me.json';
		return $this->__query($url,$params,'get');
	}
	function statuses_retweeted_to_me($params=array()) {
		$url = 'https://twitter.com/statuses/retweeted_to_me.json';
		return $this->__query($url,$params,'get');
	}
	function statuses_retweeted_of_me($params=array()) {
		$url = 'https://twitter.com/statuses/retweeted_of_me.json';
		return $this->__query($url,$params,'get');
	}
	/* Status Wrappers */
	function statuses_show($params=array()) {
		$url = 'https://twitter.com/statuses/show.json';
		return $this->__query($url,$params,'get');
	}
	...
	function statuses_destroy($params=array()) {
		$url = 'https://twitter.com/statuses/destroy.json';
		return $this->__query($url,$params,'post');
	}
	function statuses_retweet($params=array()) {
		$url = 'https://twitter.com/statuses/retweet.json';
		return $this->__query($url,$params,'post');
	}
	function statuses_retweets($params=array()) {
		$url = 'https://twitter.com/statuses/retweets.json';
		return $this->__query($url,$params,'get');
	}
	/* User */
	...
	function users_search($params=array()) {
		$url = 'https://twitter.com/users/search.json';
		return $this->__query($url,$params,'get');
	}
	...
	function direct_messages_sent($params=array()) {
		$url = 'https://twitter.com/direct_messages/sent.json';
		return $this->__query($url,$params,'get');
	}
	...
	function direct_messages_destroy($params=array()) {
		$url = 'https://twitter.com/direct_messages/destroy.json';
		return $this->__query($url,$params,'post');
	}
	/* Friendship */
	function friendships_create($params=array()) {
		$url = 'https://twitter.com/friendships/create.json';
		return $this->__query($url,$params,'post');
	}
	function friendships_destroy($params=array()) {
		$url = 'https://twitter.com/friendships/destroy.json';
		return $this->__query($url,$params,'post');
	}
	...
	function friends_ids($params=array()) {
		$url = 'https://twitter.com/friends.json';
		return $this->__query($url,$params,'get');
	}
	function followers_ids($params=array()) {
		$url = 'https://twitter.com/followers.json';
		return $this->__query($url,$params,'get');
	}
	/* Account */
	...
	function account_update_profile_background_image($params=array()) {
		$url = 'https://twitter.com/account/update_profile_background_image.json';
		return $this->__query($url,$params,'post');
	}
	...
	function favorites_create($params=array()) {
		$url = 'https://twitter.com/favorites/create.json';
		return $this->__query($url,$params,'post');
	}
	function favorites_destroy($params=array()) {
		$url = 'https://twitter.com/favorites/destroy.json';
		return $this->__query($url,$params,'post');
	}
	/* Notification */
	function notifications_follow($params=array()) {
		$url = 'https://twitter.com/notifications/follow.json';
		return $this->__query($url,$params,'post');
	}
	function notifications_leave($params=array()) {
		$url = 'https://twitter.com/notifications/leave.json';
		return $this->__query($url,$params,'post');
	}
	/* Block */
	function blocks_create($params=array()) {
		$url = 'https://twitter.com/blocks/create.json';
		return $this->__query($url,$params,'post');
	}
	function blocks_destroy($params=array()) {
		$url = 'https://twitter.com/blocks/destroy.json';
		return $this->__query($url,$params,'post');
	}
	...
	function blocks_blocking($params=array()) {
		$url = 'https://twitter.com/blocks/blocking.json';
		return $this->__query($url,$params,'get');
	}
	function blocks_blocking_ids($params=array()) {
		$url = 'https://twitter.com/blocks/blocking/ids.json';
		return $this->__query($url,$params,'get');
	}
	/* Spam Reporting */
	function report_spam($params=array()) {
		$url = 'https://twitter.com/report_spam.json';
		return $this->__query($url,$params,'post');
	}
	/* Oauth */
