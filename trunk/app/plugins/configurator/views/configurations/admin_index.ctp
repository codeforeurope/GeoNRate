...
<div id="content" class="full">
	<h2>
		<?php __d('configurator', 'Configurations');?>
	</h2>
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr <?php echo $class;?>>
			...
			<td><?php echo $this->Html->link($cfg['Configuration']['title'], array('action' => 'view', $cfg['Configuration']['id'])); ?>
			</td>

			<td><?php echo $this->Html->link($cfg['Configuration']['key'], array('action' => 'view', $cfg['Configuration']['id'])); ?>
			</td>

			<td><?php echo $cfg['Configuration']['description']; ?>
			</td>

			<td><?php echo $this->Text->truncate(htmlspecialchars($cfg['Configuration']['value']), 50); ?>&nbsp;</td>
			<td class="actions"><?php //echo $html->link(__('Details', true), array('action' => 'view', $user['User']['id']),array('class'=>'link_view')).' '; ?>
				<?php 
	...
	<p>
		<?php echo $this->Paginator->counter(array('format' => __d('configurator', 'Page %page% of %pages%, showing %current% records out of %count% total, starting on record %start%, ending on %end%', true))); ?>
	</p>
