...
<div id="debug-kit-toolbar">
	...
	<p class="warning">
		<?php __d('debug_kit', 'There are no active panels. You must enable a panel to see its output.'); ?>
	</p>
	<?php else: ?>
	<ul id="panel-tabs">
		<li class="panel-tab icon"><a href="#hide" id="hide-toolbar"> <?php echo $html->image('/debug_kit/img/cake.icon.png', array('alt' => 'CakePHP')); ?>
		</a>
		</li>
		...
		?>
			<div class="panel-content" id="<?php echo $panelUnderscore ?>-tab">
				<a href="#" class="panel-maximize">[+]</a> <a href="#"
					class="panel-minimize">[-]</a>
