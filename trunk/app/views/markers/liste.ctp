...
<?php		
	...
	if (!$session->read('Auth.User.id') || $userGroup == $uGroupSysAdmin) {	
	$html->addcrumb(
			__('Map',true),
		array(
		'controller'=>'markers',
			...
			<div class="markers index">
				<div id="listNoscript">
					...
					?>
							...
							<!--	<span><small><?php echo $marker['User']['nickname']; ?>, gemeldet: <?php echo $datum->date_it($marker['Marker']['created'],1);?></small></span> -->
							<ul>
