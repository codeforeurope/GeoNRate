...
echo $form->input('Marker.subject', array('value' => 'deprecated', 'div' => 'input text required', 'before' => __('<div>Enter a short subject</div>',true), 'maxlength'=>'128', 'label' => __('Subject',true)));
echo '</div>';
...
echo '<div style="visibility:hidden">';
echo $form->input('Marker.category_id',array('value' => 32, 'div' => 'input text required', 'before' => __('<div>Please take a look at the categories</div>',true), 'label' => __('Category',true), 'empty' => __('Please choose',false)));
echo '</div>';
